...
using Natedpalm.Blog.Core.Events;
using Natedpalm.Blog.Core.Handlers;
using Natedpalm.Blog.Core.Interfaces;
using Moq;
using Xunit;

namespace Natedpalm.Blog.UnitTests.Core.Handlers
{
